...
test("decodes the testnet sponsor-platform print buffer", () => {
  const hex =
    "";
  const decoded = decodePrintHex(hex);
  assert.equal(decoded.event, "sponsor-platform");
  assert.equal(decoded.values.amount, "50000000");
  assert.equal(decoded.values.cycles, "1");
  assert.equal(
    decoded.values["sponsor-contract"],
    "ST300KR5ZKJCGQGSFF84CNAQ3V557CNXWM94PFDG5.stackspot-sponsor",
  );
});
